...
export const KinematicsChart: React.FC<KinematicsChartProps> = ({ data, mobiles, xAxisLabel, yAxisLabel, dataKey, animationTime, keyEvents, simulationTime }) => {
    return (
        <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data} margin={{ top: 5, right: 20, left: 10, bottom: 25 }}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="time" type="number" domain={[0, simulationTime]} allowDataOverflow label={{ value: xAxisLabel, position: 'insideBottom', offset: -15 }} />
