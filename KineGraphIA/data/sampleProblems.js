export const SAMPLE_PROBLEMS = [
  {
    ...
    enunciat:
      'Dos cotxes parteixen alhora. El primer surt del repòs i accelera 2 m/s². El segon manté una velocitat constant de 10 m/s.',
    resposta: {
      mobils: [
  ...
  },
  {
    ...
    enunciat:
      'Un tren surt del repòs amb acceleració 1,5 m/s² durant 8 segons. Un altre tren circula a 12 m/s constants i es vol comparar el moviment durant 12 segons.',
    resposta: {
      mobils: [
  ...
  },
  {
    ...
    enunciat:
      "Llancem dues boles des d'una torre de 20 metres. La primera la deixem caure des del repòs. La segona la llencem cap avall amb velocitat inicial de 5 m/s. Compara-les durant 3 segons.",
    resposta: {
      mobils: [
  ...
  },
  {
    ...
    enunciat:
      "Llancem una pilota cap amunt amb velocitat inicial de 18 m/s des d'una alçada de 1,5 m. Analitzem els primers 6 segons.",
    resposta: {
      mobils: [
  ...
  },
  {
    ...
    enunciat:
      "Una pilota es dispara amb velocitat inicial de 22 m/s amb un angle de 40° respecte l'horitzontal. Analitza el moviment vertical durant 4,5 segons.",
    resposta: {
      mobils: [
