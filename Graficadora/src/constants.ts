...
export const THEMES: Record<Theme, ThemeConfig> = {
  light: {
    ...
    textColorValue: '#1e293b', // slate-800
    secondaryTextColorValue: '#64748b', // slate-500
    headerGradient: 'from-blue-500 to-indigo-600',
    bgColorValue: '#f1f5f9', // slate-100
  },
  dark: {
    bg: 'bg-gray-900',
    text: 'text-gray-100',
    ...
    textColorValue: '#f3f4f6', // gray-100
    secondaryTextColorValue: '#9ca3af', // gray-400
    headerGradient: 'from-sky-400 to-cyan-300',
    bgColorValue: '#11182c', // gray-900
  },
  chalkboard: {
    bg: 'bg-[#2a3c2e]',
    text: 'text-gray-100',
    ...
    textColorValue: '#f3f4f6', // gray-100
    secondaryTextColorValue: '#d1d5db', // gray-300
  ...
  'high-contrast': {
    ...
    textColorValue: '#ffffff', // white
    secondaryTextColorValue: '#e5e7eb', // gray-200
